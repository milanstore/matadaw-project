  ...
  return (
    <div className="bg-homeBg bg-[#010101] bg-cover bg-no-repeat">
      ...
      <div className="flex justify-center items-center gap-20 lg:w-[90%] xl:w-[80%] mx-auto py-28 flex-wrap">
        <div className="w-full sm:w-[80%] lg:w-[40%] mx-auto flex flex-col justify-center items-center">
          <div>
            <img src={Img} alt="" />
        ...
        <div className="border border-[#e45d01] px-4 sm:px-11 py-9 rounded-xl custom-form-bg flex-1 mx-5 sm:mx-10 lg:mx-0">
          {/* form */}
          <Form />
          {/* Terms & Conditions */}
